...
import { AIPicker, ColourPicker, FilePicker, CustomButton, Tab } from "../components";
...
const Customizer = () => {
    ...
    const handleSubmit = async (type) => {
        if (!prompt) return alert("Pleas enter a prompt");
    ...
    return <AnimatePresence>
        {
            !snap.intro && (
                <>
                    <motion.div key={"custom"} className="absolute top-0 left-0 z-10" {...slideAnimation}>
